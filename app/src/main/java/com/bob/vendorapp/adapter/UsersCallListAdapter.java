...
import com.bob.vendorapp.ui.CallActivity;
import com.bob.vendorapp.ui.ChatActivity;

import java.util.ArrayList;

public class UsersCallListAdapter extends RecyclerView.Adapter<UsersCallListAdapter.MyViewHolder>{

    private ArrayList<UsersModel> users;
    private Context context;

    public UsersCallListAdapter(ArrayList<UsersModel> users, Context context) {
        this.users = users;
